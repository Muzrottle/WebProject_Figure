						...
						<div class="dropdown-menu cart-dropdown">
							...
							<div class="media">
								<a class="pull-left" href="#!">
									<img class="media-object" src="{{ asset('images/shop/cart/cart-1.jpg')}}" alt="image" />
								</a>
							...
							<div class="media">
								<a class="pull-left" href="#!">
									<img class="media-object" src="{{ asset('images/shop/cart/cart-2.jpg')}}" alt="image" />
								</a>
								<div class="media-body">
									<h4 class="media-heading"><a href="#!">Ladies Bag</a></h4>
									<div class="cart-price">
					...
					<li class="dropdown full-width dropdown-slide">
						...
						<div class="dropdown-menu">
							<div class="row">
								...
								<div class="col-sm-3 col-xs-12">
									<a href="/shop">
										<img class="img-responsive" src="{{ asset('images/shop/header-img.jpg')}}" alt="menu image" />
									</a>
								</div>
							</div><!-- / .row -->
						</div><!-- / .dropdown-menu -->
